...
export const EnvSchema = z
  .object({
    ...
    IMMICH_STORAGE_ENGINE: z.enum(['local', 's3']).optional(),
    ...
    S3_USE_ACCELERATE: stringBool.optional(),
    S3_SSE: z
      .string()
      .regex(/^(AES256|aws:kms|S3|KMS)$/i, 'S3_SSE must be AES256, aws:kms, S3, or KMS')
      .optional(),
